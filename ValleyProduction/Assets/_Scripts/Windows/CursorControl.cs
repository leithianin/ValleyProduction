...
public static class CursorControl
{
    ...
    private static Vector3 saveMousePosition;
    ...
    /// <summary>
    /// Save the current Mouse Position in a local variable
    /// </summary>
    public static void SetSaveMousePosition()
    {
        saveMousePosition = GetPosition();
    }

    /// <summary>
    /// Set the mouse Position at the local variable saved position 
    /// </summary>
    public static void SetAtSaveMousePosition()
    {
        SetPosition(saveMousePosition);
    }
}