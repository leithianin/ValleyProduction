...
public abstract class InteractionSight : MonoBehaviour
{
    ...
    /// <summary>
    /// Actions sp�cifiques � faire lors du commencement d'une interaction.
    /// </summary>
    /// <param name="spot">L'objet avec lequel il interagit.</param>
    public abstract void OnStartInteraction(InteractionSpot spot);

    /// <summary>
    /// Actions sp�cifiques � faire lors de la fin d'une interaction.
    /// </summary>
    public abstract void OnEndInteraction();

    /// <summary>
    /// Appel� quand on demande � interagir avec un Spot.
    /// </summary>
    ...
    /// <summary>
    /// Appel� quand l'interaction avec le Spot se finit.
    /// </summary>
