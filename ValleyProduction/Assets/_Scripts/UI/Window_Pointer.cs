...
public class Window_Pointer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 objScreenPos = cam.WorldToScreenPoint(Target.transform.position);
        ...
        rt.localEulerAngles = new Vector3(rt.localEulerAngles.x, rt.localEulerAngles.y, angle+180);
    }
}
